...
> {
  ...
  _renderOuterButton = (
    ...
    if (name === 'Skip') {
      const style = styles.leftButtonContainer
      return (
        <View style={!this.props.bottomButton && {
          position: 'absolute',
          left: 10, top: 20
        }}>
          <TouchableOpacity
      ...
      const style = name === 'Prev' ? styles.leftButtonContainer :
  ...
  render() {
    ...
    return (
      <View style={styles.flexOne}>
        ...
        <TouchableOpacity style={{ position: 'absolute', left: 16, top: Platform.OS == 'ios' ? 30 : 16, zIndex: 99 }} onPress={this.props.onSkip} >
          <Text style={[commonStyle.h4, { marginTop: 10, color: Colors.Gray }]}>{translate('Intro.lbl_skip')}</Text>
        </TouchableOpacity>
      </View>
    );
  }
