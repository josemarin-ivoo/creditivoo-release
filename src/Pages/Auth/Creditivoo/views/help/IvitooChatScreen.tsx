...
const IvitooChatScreen = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch('https://automatiza-c1on-n8n.ovf68d.easypanel.host/webhook/13d08ce3-b2bc-442a-9390-3c53f40e7727/chat', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ chatInput: userMsg.text }),
      });
      ...
      const botMsg: Message = {
        ...
        text: data.output || data.text || 'Entendido, estoy procesando tu solicitud.',
        sender: 'ivitoo',
      };
