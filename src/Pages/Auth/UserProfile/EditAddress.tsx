      ...
      <View style={{paddingHorizontal: 16, flex: 1}}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={{flex: 1}}>
                  ...
                  <View
                    ...
                    ]}>
                    {
                      <Image
                        source={
                          addressType == 1
                            ? ImageResources.ic_add_home_de_selected
                            : isDark
                            ? ImageResources.ic_add_home_de_new
                            : ImageResources.ic_add_home_de
                        }
                  ...
                  <View
                    ...
                    ]}>
                    {
                      <Image
                        source={
                          addressType == 2
                            ? ImageResources.ic_add_work_selected
                            : isDark
                            ? ImageResources.ic_add_work_new
                            : ImageResources.ic_add_work
                        }
                        style={styles.type_icon}
                      />
                    }
                  ...
                  <View
                    ...
                    ]}>
                    {
                      <Image
                        source={
                          addressType == 3
                            ? ImageResources.ic_add_other_selected
                            : isDark
                            ? ImageResources.ic_add_other_new
                            : ImageResources.ic_add_other
                        }
                        style={styles.type_icon}
                      />
                    }
            ...
            <CustomPBar showProgress={eLoading} />
            {dataCity != undefined &&
              dataCity.nearestCityList != undefined &&
              Platform.OS == 'ios' && (
                <View
