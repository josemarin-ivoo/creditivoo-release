...
const OtpInput = forwardRef<TextInput, Props>(
  (
    ...
    return (
      <View style={[inputContainerStyles, focused && focusStyles,{ flex: .23, }]}>
        <TextInput
          ...
          style={[commonStyle.h3_otp,commonStyle.input, commonStyle.fontBold, { flexDirection: "row", flexWrap: "wrap",textAlign: "center", height: 88 }]} 
