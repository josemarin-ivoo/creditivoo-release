...
import {setCurrentPurchase} from '../../store/slices/purchase-slice';
import {
      ...
      <CurvedHeaderLayout
        ...
        <View
          style={[
            ...
            {paddingBottom: insets.bottom + SCREEN_WIDTH * 0.05},
          ]}>
          <Image
          ...
          <Text style={styles.messageText}>
            Tienes una compra pendiente de pago. Por favor, termina de pagar las
            cuotas antes de realizar una nueva compra.
          </Text>
          <Button
...
const styles = StyleSheet.create({
  ...
  messageContainer: {
    ...
    paddingHorizontal: SCREEN_WIDTH * 0.1,
    paddingTop: Platform.select({
      ios: SCREEN_HEIGHT * 0.02,
      android: SCREEN_HEIGHT * 0.05,
    }),
  },
  messageTitle: {
